...
| 8b | GET | `/api/agents/:id/instructions` | 에이전트 instructions 버전 이력 |
| 9 | PUT | `/api/agents/:id` | 에이전트 수정 |
| 10 | POST | `/api/agents/:id/promote` | 메인 승격 |
| 11 | DELETE | `/api/agents/:id` | 에이전트 삭제 |
| 11a | GET | `/api/workspaces/:workspace/skills` | 워크스페이스 Skill 목록 |
| 11b | POST | `/api/workspaces/:workspace/skills` | Skill 생성/갱신 |
| 11c | GET | `/api/skills/:id` | Skill 상세 |
| 11d | PUT | `/api/skills/:id` | Skill 수정 |
| 11e | DELETE | `/api/skills/:id` | Skill 삭제 |
| 11f | GET | `/api/agents/:id/skills` | 에이전트 Skill 할당 목록 |
| 11g | POST | `/api/agents/:id/skills` | 에이전트 Skill 할당/갱신 |
| 11h | DELETE | `/api/agents/:id/skills/:skillID` | 에이전트 Skill 해제 |
...
| 18a | GET | `/api/issues/:id/subissues` | 하위 이슈 목록 |
| 18b | POST | `/api/issues/:id/subissues` | 하위 이슈 생성 |
...
| 23a | GET | `/api/runs/:id/events` | run 이벤트 타임라인 |
...
| 30a | GET | `/api/usage/summary` | token/cost 사용량 요약 |
...
- 고급 chain 관리 UI와 MCP readonly tool pilot
...
### 10.5 Auto-chain opt-in API (구현됨)
