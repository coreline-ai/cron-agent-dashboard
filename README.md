...
| 남은 개선 후보 | 관리 가능 | execution 필터의 SQL-level pagination 정밀화, Gemini prompt argv 전달 개선, `auto_close_on_run_done` 설정 UI 노출, dev-only Vite/esbuild audit 업데이트 |
...
| [🔌 API](docs/API.md) | 47 REST route · 멘션 규칙 · identifier resolve |
